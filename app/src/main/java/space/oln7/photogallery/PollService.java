...
public class PollService extends IntentService {
    ...
    public static final String ACTION_SHOW_NOTIFICATION = "space.oln7.photogallery.SHOW_NOTIFICATION";
    public static final String PERM_PRIVATE = "space.oln7.photogallery.PRIVATE";
